import unittest
from lab04 import isNumber, getOper, infix_to_postfix, getRpn, calcRpn
...
class TestCalculator(unittest.TestCase):
    ...
    def test_infix_to_postfix(self):
        self.assertEqual(infix_to_postfix('22 / 11 + 23 * 2 * ( 24 / 2 ) ^ 2'), ['22', '11', '/', '23', '2', '*', '24', '2', '/', '2', '^', '*', '+'])
        self.assertEqual(infix_to_postfix('48 / 4 + 156 * 24 * ( 40 / 5 ) ^ 4'), ['48', '4', '/', '156', '24', '*', '40', '5', '/', '4', '^', '*', '+'])
